...
declare const _default: React.ComponentClass<Pick<ItemProps, "children" | "text" | "to" | "id" | "color" | "icon" | "labels" | "activeOn" | "highlighted">, any> & import("react-router").WithRouterStatics<ItemComponent>;
